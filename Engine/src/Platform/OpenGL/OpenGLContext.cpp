...
namespace Kaleidoscope
{
    ...
    void OpenGLContext::Init()
    {
        ...
        KLD_CORE_INFO("  Renderer: {0}", reinterpret_cast<const char *>(glGetString(GL_RENDERER)));
        KLD_CORE_INFO("  Version: {0}", reinterpret_cast<const char *>(glGetString(GL_VERSION)));
