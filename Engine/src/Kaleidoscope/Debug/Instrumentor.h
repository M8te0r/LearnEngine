...
#define KLD_PROFILE 1
    ...
    #else
        #define KLD_PROFILE_FUNCTION() KLD_PROFILE_SCOPE(__FUNCTION__)
    #endif
#else
    #define KLD_PROFILE_BEGIN_SESSION(name, filepath)
    #define KLD_PROFILE_END_SESSION()
    #define KLD_PROFILE_SCOPE(name)
    #define KLD_PROFILE_FUNCTION()
#endif