...
void Sandbox2D::OnUpdate(Kaleidoscope::Timestep ts)
{
...

    {
        ...
        Kaleidoscope::Renderer2D::DrawQuad({-5.0f, -5.0f, -0.1f}, {10.0f, 10.0f}, m_CheckerboardTexture, 10.0f);
        Kaleidoscope::Renderer2D::DrawQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, m_CheckerboardTexture, 20.0f);
